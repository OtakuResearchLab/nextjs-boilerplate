                ...
                <div className="flex min-w-0 flex-col justify-center">
                  ...
                  <div className="mt-5 flex justify-end">
                    <a
                      ...
                      className="group relative flex h-11 w-11 items-center justify-center rounded-2xl border border-[#cbd6de] bg-[#f5f8fa] text-sm font-black text-[#52799a] shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-[#88a9bf] hover:bg-[#edf4f8] hover:shadow-md"
                    >
                      問
                      <span className="absolute -bottom-[4px] right-2 h-2.5 w-2.5 rotate-45 border-b border-r border-[#cbd6de] bg-[#f5f8fa] transition group-hover:border-[#88a9bf] group-hover:bg-[#edf4f8]" />
                    </a>
                  </div>
                </div>
              </div>
